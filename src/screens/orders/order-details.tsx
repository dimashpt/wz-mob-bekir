      ...
      >
        <Card className="flex-row items-center justify-between">
          <View className="gap-sm flex-row items-center">
            ...
            <View>
              <Text variant="labelM">{data?.store_name}</Text>
        ...
        <Card>
          <Text variant="labelM">{t('order_details.customer')}</Text>
          <View className="gap-sm flex-row items-center">
            ...
            <Text>{data?.buyer_name}</Text>
          </View>
        </Card>
        <Card>
          <Text variant="labelM">{t('order_details.order_summary')}</Text>
          <View className="flex-row items-center justify-between">
            <Text variant="bodyS">{t('order_details.origin_warehouse')}</Text>
            <Text variant="labelS">{data?.location_name}</Text>
          </View>
          <View className="flex-row items-center justify-between">
            <Text variant="bodyS">{t('order_details.payment_method')}</Text>
            <Text variant="labelS">{data?.payment_method}</Text>
          </View>
          <View className="flex-row items-center justify-between">
            <Text variant="bodyS">{t('order_details.payment_type')}</Text>
            <Text variant="labelS">{data?.payment_via}</Text>
          </View>
          <View className="flex-row items-center justify-between">
            <Text variant="bodyS">{t('order_details.courier')}</Text>
            <Text variant="labelS">{data?.logistic_carrier}</Text>
          </View>
          <View className="flex-row items-center justify-between">
            <Text variant="bodyS">{t('order_details.actual_weight')}</Text>
            <Text variant="labelS">{data?.actual_package_weight}</Text>
          </View>
          <View className="flex-row items-center justify-between">
          ...
          <View className="flex-row items-center justify-between">
            ...
            <Text variant="labelS">{data?.delivery_attempt ?? 0}</Text>
          </View>
          <View className="flex-row items-center justify-between">
            <Text variant="bodyS">{t('order_details.tracking_number')}</Text>
            <Text variant="labelS">{data?.tracking_number ?? '-'}</Text>
          </View>
        </Card>
        <Card>
          <Text variant="labelM">{t('order_details.products')}</Text>
          <FlatList
            ...
            renderItem={({ item }) => (
              ...
              >
                ...
                <View className="gap-xs flex-1">
                  <Text variant="labelS">{item?.product_name}</Text>
                  <Text variant="bodyXS" color="muted">
                  ...
                  <View className="gap-md flex-row items-center justify-between">
                    ...
                    <Divider className="bg-border h-px flex-1" />
        ...
        <Card>
          <Text variant="labelM">{t('order_details.fees')}</Text>
          <View className="flex-row items-center justify-between">
          ...
          <View className="flex-row items-center justify-between">
            <Text variant="bodyS">{t('order_details.shipping_discount')}</Text>
            <Text variant="labelS">
        ...
        <Card>
          <Text variant="labelM">{t('order_details.shipping_address')}</Text>
          <View className="gap-sm">
            <Text variant="bodyS">{data?.recipient_name}</Text>
            <Text variant="bodyS">{data?.recipient_phone}</Text>
            <Text variant="bodyS">{data?.recipient_email ?? '-'}</Text>
            <Text variant="bodyS">{data?.recipient_full_address}</Text>
          </View>
        </Card>
        <Card>
          <Text variant="labelM">{t('order_details.package_information')}</Text>
          <View className="flex-row items-center justify-between">
            <Text variant="bodyS">{t('order_details.height_cm')}</Text>
            <Text variant="labelS">{data?.package_height}</Text>
          </View>
          <View className="flex-row items-center justify-between">
            <Text variant="bodyS">{t('order_details.length_cm')}</Text>
            <Text variant="labelS">{data?.package_length}</Text>
          </View>
          <View className="flex-row items-center justify-between">
            <Text variant="bodyS">{t('order_details.width_cm')}</Text>
            <Text variant="labelS">{data?.package_width}</Text>
          </View>
          <View className="flex-row items-center justify-between">
            <Text variant="bodyS">{t('order_details.weight_g')}</Text>
            <Text variant="labelS">{data?.package_weight}</Text>
          </View>
          <View className="flex-row items-center justify-between">
            <Text variant="bodyS">
